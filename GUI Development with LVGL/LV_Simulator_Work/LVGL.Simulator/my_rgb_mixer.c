...
static void my_callback_function(lv_event_t *the_event)
{
    ...
    lv_label_set_text_fmt(user_data->label, "%d", my_value);
...
void rgb_mixer_create_UI(void)
{
    ...
    lv_obj_set_width(base_object_rectangle, 220);
